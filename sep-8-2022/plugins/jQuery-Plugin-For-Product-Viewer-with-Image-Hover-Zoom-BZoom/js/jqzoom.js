    ...
    if (
      ...
      if (!$(".bzoom_magnifier").length) {
        ...
        $bzoom_magnifier_img
          .attr(
            "src",
            $ul.find(".bzoom_thumb_active .bzoom_thumb_image").attr("src")
          )
          .css({
            width: _option.thumb_image_width,
            height: _option.thumb_image_height,
      ...
      if (!$(".bzoom_zoom_area").length) {
        ...
        if (_option.align == "left") {
          top = 50;
          left = 50 + _option.thumb_image_width + _option.zoom_area_distance;
        }
      ...
      $li
        ...
        .mouseleave(function (event) {
          ...
          $bzoom_magnifier
            .stop()
            .animate({ opacity: 0 }, _option.speed * 0.7, function () {
              $(this).hide();
            });
